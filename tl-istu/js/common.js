$(function() {
	...
	function close() {
		...
		$('.site-header-nav-ul').removeClass('appear');
		...
		setTimeout(function() { 
			...
			$('.site-header-nav-ul').removeClass('isDisplay'); 
		}, 410);
	}
	...
	$('.content-container-social-wrapper-a').hover(function() {
		$(this).parent().prev('.content-container-social-a').toggleClass('zoomSocial');
		// $('.content-container-social-a').toggleClass('zoomSocial');
	});
	...
	$('.site-header-nav-toggle_menu').on('click', function() {
		if ($('.site-header-nav-ul').hasClass('appear')) {
			$('.site-header-nav-ul').removeClass('appear');
			$('.overlay').removeClass('appear');
			$('.site-header-nav-toggle_menu').removeClass('active');
			$('.site-header').removeClass('z-index10');
			...
			$('.site-header-nav-ul').addClass('isDisplay');
			$('.overlay').addClass('isDisplay');
			$('.site-header').addClass('z-index10');
			setTimeout(function() { 
				$('.site-header-nav-ul').addClass('appear');
				$('.overlay').addClass('appear'); 
			}, 10);
		}
	});
